...
{   
    ...
    private $priveParent = 'Propriété privé PARENT <br>';
    protected $protegeParent = 'Propriété protégé PARENT <br>';

    public function affichage()
    {   echo '=========Methode affichage========== <br>';

        // Propriété Parent
        echo '==Propriétés PARENT== <br>';
        echo $this->publiqueParent; // OK
        echo $this->priveParent; // OK
        echo $this->protegeParent; // OK
        
        //! Ces Propriété sont disponible quand l'enfant l'appel mais pas le parent
        // Propriété Enfant
        echo '==Propriétés ENFANT== <br>';
        ...
        echo $this->publiqueEnfant; // Notice error
        //echo $this->priveEnfant; // Ne fonctionne pas car seul l'enfant peut l'appeler ( scope private )
        echo $this->protegeEnfant; // Notice error
        echo '<br><br><br><br>';
    }
}
$ClassParent = new ParentTest();
//echo $ClassParent->publiqueParent;// OK ( Public )
//echo $ClassParent->priveParent;// Erreur fatale. ( Private )
//echo $ClassParent->protegeParent;// Erreur fatale. ( Protected )

echo '================================ <br>
        CLASSE PARENT<br>
      ================================ <br>';

$ClassParent->affichage(); // affiche tout les types de propriété appeler dans la méthode affichage() sauf les propriété de l'enfant
...
{   
    public $publiqueEnfant = 'Propriété public ENFANT <br>';
    private $priveEnfant = 'Propriété privé ENFANT <br>';
    protected $protegeEnfant = 'Propriété protégé ENFANT <br>';

    public function affichageEnfant()
    {   echo '=========Methode affichageEnfant========== <br>';
        // Propriété Parent
        echo '==Propriétés PARENT== <br>';
        echo $this->publiqueParent; // OK
        //echo $this->priveParent; // Ne fonctionne pas car seul le parent peut l'appeler ( scope private )
        echo $this->protegeParent; // OK

        // Propriété Enfant
        echo '==Propriétés ENFANT== <br>';
        echo $this->publiqueEnfant; // OK
        echo $this->priveEnfant; // OK
        echo $this->protegeEnfant; // OK
        echo '<br><br><br><br>';
    }
}
...
//echo $ClassEnfant->priveParent;// Erreur fatale. ( Private )
//echo $ClassEnfant->protegeParent;// Erreur fatale. ( Protected )
...
//$constanteTest = new ConstanteTest(); // Pas d'instancier pour utiliser une constante ( comme pour le static )
echo ConstanteTest::LOL; // Appel comme le static pour afficher cette constante
